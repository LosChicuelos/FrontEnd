...
class MessagesList extends Component {
  ...
  render() {
    ...
    console.log("jljsakdjlkjlf",this.props.user_id)
    return (
        <div className="col" id="ProductsList">
          <br/>
            <center>
              <Messages user_id={this.props.user.id} parametros={this.props.parametros} />
            </center>
        </div>
    );
  }
...
class Messages extends Component {
  Juancho(){
    console.log("ComponentWill", this.props.user_id)
    ...
    if(this.props.user_id===undefined){
      ...
      {
        console.log("respuesta undefined",response.data);
      ...
      if(this.props.parametros.includes("sender_id")){
        ...
        {
          console.log("respuesta includes",response.data);
          this.setState({messages: response.data})
        }
        );
      } else {
        ...
        {
          console.log("respuesta else",response.data);
          this.setState({messages: response.data});
        }
        );
      }
  ...
  render() {
    ...
    console.log("JUANCHO", this.props.user_id)
    this.Juancho()
    return(
